	...
	<div class="row">
		<div class="f_menu">
			<div class="columns three">
				<div class="collapse">Site Map</div>
				<ul class="about_collapse">
			...
			<div class="columns three">
				<div class="collapse">Bike Categories</div>
				<ul class="about_collapse">
			...
			<div class="columns three">
				<div class="collapse">Accessories</div>
				<ul>
			...
			<div class="columns three">
				<div class="collapse">Other</div>
				<ul class="about_collapse">
					<li><a href="contact.php">Contact us</a></li>
					<li><a href="store.php">Find an outlet</a></li>
					<li><a href="quality.php">Quality Certificates</a></li>
					<li><a href="catalogue.php">Catalogue</a></li>
				</ul>
			</div>
			<div class="f_social columns five">
				<span class="s_con">
					<a href="https://www.facebook.com/durantabicycle"><div class="facebook"></div></a>
					<a href="https://www.youtube.com/channel/UCEvTYT2UGLR_k7aXpopMBdA"><div class="youtube"></div></a>
					<a href="https://instagram.com/duranta.bicycle?igshid=YmMyMTA2M2Y="><div class="instagram"></div></a>
				</span>
				<p class="copyright center">&copy; 2016. Duranta Bikes All Rights Reserved</p>
			</div>
		</div>
	</div>
</div>
...
<script src="lib/js/mobile-nav/jquery.slicknav.js"></script>
...
<!--IMAGE GALLERY-->
<script src="lib/js/jquery.littlelightbox.js"></script>
<script>
	$('.image-galery li').littleLightBox();
	$('.partners-galery li').littleLightBox();
</script>
